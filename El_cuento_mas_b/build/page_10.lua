...
local comodin = kwkVarCheck("comodin") 
       ...
       -- Text positioning 
       Text = display.newImageRect( imgDir.. "p10_text.png", 1368, 126 ); 
       ...
       function hideRosa(event) 
         if (hasRosa == true) then 
            transitionStash.newTransition_694 = transition.to( kwkRosa, {alpha=0, time=100, delay=0}) 
         end 
       end 
      ...
      --End Actions (functions) 
       ...
       function btnNextPage(self) 
            ...
            timerStash.newTimer_764 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
       ...
       function btnPrevPage(self) 
            ...
            timerStash.newTimer_765 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
