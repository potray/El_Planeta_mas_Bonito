...
function new() 
    ...
    -- Audio callings 
    local narracion_page4 =  audio.loadStream( audioDir.."narracion_page4.mp3") 
...
local hasCola = kwkVarCheck("hasCola") 
       ...
       Cabeza_mama_sor = display.newImageRect( imgDir.. "p5_cabeza_mama_sor.png", 478, 510 ); 
       ...
       Cabeza_hija_sor = display.newImageRect( imgDir.. "p5_cabeza_hija_sor.png", 319, 390 ); 
       ...
       -- Text positioning 
       Text = display.newImageRect( imgDir.. "p5_text.png", 1438, 109 ); 
       Text.x = 1276; Text.y = 97; Text.alpha = 1; Text.oldAlpha = 1 
       ...
       Cabeza_bebe_sor = display.newImageRect( imgDir.. "p5_cabeza_bebe_sor.png", 356, 283 ); 
       ...
       function hideInventory(event) 
            transitionStash.newTransition_971 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_971 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_972 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_972 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_972 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_972 = transition.to( kwkInvMaquina, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_973 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_973 = transition.to( kwkInvGuitarra, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_973 = transition.to( kwkInvCola, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_973 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
       ...
       function showInventory(event) 
         ...
         if (hasBiberon == true) then 
            transitionStash.newTransition_991 = transition.to( kwkInvBiberon, {alpha=kwkInvBiberon.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasErizo == true) then 
            transitionStash.newTransition_994 = transition.to( kwkInvErizo, {alpha=kwkInvErizo.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasCola == true) then 
            transitionStash.newTransition_996 = transition.to( kwkInvCola, {alpha=kwkInvCola.oldAlpha, time=0, delay=0}) 
         end 
           InventoryShown = true
          saveKwikVars({"InventoryShown",true}) 
            transitionStash.newTransition_012 = transition.to( kwkInvDestacado, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_012 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 
