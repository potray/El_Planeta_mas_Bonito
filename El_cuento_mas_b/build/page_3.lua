...
function new() 
    ...
    local drawScreen = function() 
       ...
       -- Fondo positioning 
       Fondo = display.newImageRect( imgDir.. "p3_fondo.png", 2560, 1598 ); 
       ...
       -- Biberon positioning 
       Biberon = display.newImageRect( imgDir.. "p3_biberon.png", 64, 158 ); 
       ...
       -- Tijeras positioning 
       Tijeras = display.newImageRect( imgDir.. "p3_tijeras.png", 95, 262 ); 
       ...
       -- Bebe positioning 
       Bebe = display.newImageRect( imgDir.. "p3_bebe.png", 378, 543 ); 
       ...
       Hija_casa = display.newImageRect( imgDir.. "p3_hija_casa.png", 476, 856 ); 
       ...
       Mama_casa = display.newImageRect( imgDir.. "p3_mama_casa.png", 548, 1052 ); 
