...
function new() 
    ...
    -- Audio callings 
    local narracion_page1 =  audio.loadStream( audioDir.."narracion_page11.mp3") 
...
local hasCola = kwkVarCheck("hasCola") 
       ...
       -- Ser_2 positioning 
       Ser_2 = display.newImageRect( imgDir.. "p13_ser_2.png", 431, 634 ); 
       ...
       kwikSer_3 = display.newImageRect( imgDir.. "p13_kwikser_3.png", 614, 979 ); 
       ...
       -- Ser_4 positioning 
       Ser_4 = display.newImageRect( imgDir.. "p13_ser_4.png", 654, 1000 ); 
       ...
       -- Ser_5 positioning 
       Ser_5 = display.newImageRect( imgDir.. "p13_ser_5.png", 683, 1134 ); 
       ...
       -- Text positioning 
       Text = display.newImageRect( imgDir.. "p13_text.png", 1414, 224 ); 
       Text.x = 1273; Text.y = 142; Text.alpha = 1; Text.oldAlpha = 1 
       ...
       function HideSeres(event) 
            transitionStash.newTransition_663 = transition.to( Ser_2, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_663 = transition.to( kwikSer_3, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_664 = transition.to( kwkSer_1, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_664 = transition.to( Ser_4, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_664 = transition.to( Ser_5, {alpha=0, time=0, delay=0}) 
           act_730() 
       end 

       function hideInventory(event) 
            transitionStash.newTransition_679 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_679 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_679 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_679 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_680 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_680 = transition.to( kwkInvMaquina, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_680 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_680 = transition.to( kwkInvGuitarra, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_681 = transition.to( kwkInvCola, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_681 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
           InventoryShown = false
          saveKwikVars({"InventoryShown",false}) 
       end 

       function showInventory(event) 
            transitionStash.newTransition_698 = transition.to( kwkRectInv, {alpha=kwkRectInv.oldAlpha, time=0, delay=0}) 
         if (hasBiberon == true) then 
            transitionStash.newTransition_698 = transition.to( kwkInvBiberon, {alpha=kwkInvBiberon.oldAlpha, time=0, delay=0}) 
         end 
         if (hasTijeras == true) then 
            transitionStash.newTransition_699 = transition.to( kwkInvTijeras, {alpha=kwkInvTijeras.oldAlpha, time=0, delay=0}) 
         end 
         if (hasMaquina == true) then 
            transitionStash.newTransition_700 = transition.to( kwkInvMaquina, {alpha=kwkInvMaquina.oldAlpha, time=0, delay=0}) 
         end 
         if (hasRosa == true) then 
            transitionStash.newTransition_701 = transition.to( kwkInvRosa, {alpha=kwkInvRosa.oldAlpha, time=0, delay=0}) 
         end 
         if (hasErizo == true) then 
            transitionStash.newTransition_701 = transition.to( kwkInvErizo, {alpha=kwkInvErizo.oldAlpha, time=0, delay=0}) 
         end 
         if (hasCelo == true) then 
            transitionStash.newTransition_702 = transition.to( kwkInvCelo, {alpha=kwkInvCelo.oldAlpha, time=0, delay=0}) 
         end 
         if (hasGuitarra == true) then 
            transitionStash.newTransition_703 = transition.to( kwkInvGuitarra, {alpha=kwkInvGuitarra.oldAlpha, time=0, delay=0}) 
         end 
         if (hasCola == true) then 
            transitionStash.newTransition_704 = transition.to( kwkInvCola, {alpha=kwkInvCola.oldAlpha, time=0, delay=0}) 
         end 
           InventoryShown = true
          saveKwikVars({"InventoryShown",true}) 
            transitionStash.newTransition_720 = transition.to( kwkInvDestacado, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_720 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 

       function act_730(event) 
            transitionStash.newTransition_721 = transition.to( kwkNavnext, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_721 = transition.to( kwkSer_1, {alpha=kwkSer_1.oldAlpha, time=1000, delay=1000}) 
            transitionStash.newTransition_721 = transition.to( Ser_2, {alpha=Ser_2.oldAlpha, time=1000, delay=2000}) 
            transitionStash.newTransition_722 = transition.to( kwikSer_3, {alpha=kwikSer_3.oldAlpha, time=1000, delay=3000}) 
            transitionStash.newTransition_722 = transition.to( Ser_4, {alpha=Ser_4.oldAlpha, time=1000, delay=4000}) 
            transitionStash.newTransition_722 = transition.to( Ser_5, {alpha=Ser_5.oldAlpha, time=1000, delay=5000}) 
            transitionStash.newTransition_722 = transition.to( kwkNavnext, {alpha=kwkNavnext.oldAlpha, time=1000, delay=6000}) 
       end 
      ...
      --End Actions (functions) 
       ...
       function btnPrevPage(self) 
            ...
            timerStash.newTimer_793 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
