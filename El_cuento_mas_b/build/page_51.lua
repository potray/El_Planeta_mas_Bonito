...
local hasCola = kwkVarCheck("hasCola") 
       ...
       function hideInventory(event) 
            transitionStash.newTransition_536 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_536 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_537 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_537 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_537 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_537 = transition.to( kwkInvMaquina, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_538 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_538 = transition.to( kwkInvGuitarra, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_538 = transition.to( kwkInvCola, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_538 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
       ...
       function showInventory(event) 
         ...
         if (hasCola == true) then 
          ...
          saveKwikVars({"InventoryShown",true}) 
            transitionStash.newTransition_578 = transition.to( kwkInvDestacado, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_579 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 

       function Anim(event) 
            transitionStash.newTransition_579 = transition.to( Text2, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_579 = transition.to( kwkNavnext, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_579 = transition.to( Text2, {alpha=Text2.oldAlpha, time=1000, delay=1500}) 
            transitionStash.newTransition_580 = transition.to( kwkNavnext, {alpha=kwkNavnext.oldAlpha, time=1000, delay=3000}) 
       end 
      ...
      --End Actions (functions) 
       ...
       function btnNextPage(self) 
         if (Fav03Completed == false) then 
            ...
            timerStash.newTimer_654 = timer.performWithDelay(0, myClosure_switch, 1) 
         end 
       end 
