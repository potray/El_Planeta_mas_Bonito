...
function new() 
    ...
    local drawScreen = function() 
       ...
       -- Fondo positioning 
       Fondo = display.newImageRect( imgDir.. "p1_fondo.png", 2560, 1598 ); 
       ...
       -- Biberon positioning 
       Biberon = display.newImageRect( imgDir.. "p1_biberon.png", 64, 158 ); 
       ...
       -- Tijeras positioning 
       Tijeras = display.newImageRect( imgDir.. "p1_tijeras.png", 95, 262 ); 
       ...
       -- Bebe positioning 
       Bebe = display.newImageRect( imgDir.. "p1_bebe.png", 378, 543 ); 
       ...
       Hija_casa = display.newImageRect( imgDir.. "p1_hija_casa.png", 476, 856 ); 
       ...
       Mama_casa = display.newImageRect( imgDir.. "p1_mama_casa.png", 548, 1052 ); 
       ...
       function hideBiberon(event) 
         if (hasBiberon == true) then 
            transitionStash.newTransition_717 = transition.to( Biberon, {alpha=0, time=100, delay=0}) 
         end 
       end 

       function hideTijeras(event) 
         if (hasTijeras == true) then 
            transitionStash.newTransition_718 = transition.to( Tijeras, {alpha=0, time=0, delay=0}) 
         end 
       end 
