...
local hasCola = kwkVarCheck("hasCola") 
       ...
       -- Text positioning 
       Text = display.newImageRect( imgDir.. "p14_text.png", 1131, 39 ); 
       Text.x = 1335; Text.y = 192; Text.alpha = 1; Text.oldAlpha = 1 
       ...
       function hideInventory(event) 
            transitionStash.newTransition_371 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_372 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_373 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_374 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_375 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            ...
            transitionStash.newTransition_378 = transition.to( kwkInvCola, {alpha=0, time=0, delay=0}) 
       ...
       function showInventory(event) 
         ...
         if (hasTijeras == true) then 
            transitionStash.newTransition_399 = transition.to( kwkInvTijeras, {alpha=kwkInvTijeras.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasRosa == true) then 
            transitionStash.newTransition_402 = transition.to( kwkInvRosa, {alpha=kwkInvRosa.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasGuitarra == true) then 
            transitionStash.newTransition_407 = transition.to( kwkInvGuitarra, {alpha=kwkInvGuitarra.oldAlpha, time=0, delay=0}) 
         end 
         if (hasCola == true) then 
            transitionStash.newTransition_408 = transition.to( kwkInvCola, {alpha=kwkInvCola.oldAlpha, time=0, delay=0}) 
         end 
           InventoryShown = true
      ...
      --End Actions (functions) 
       ...
       function btnNextPage(self) 
            ...
            timerStash.newTimer_476 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
