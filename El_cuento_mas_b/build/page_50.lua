...
local hasCola = kwkVarCheck("hasCola") 
       ...
       -- Botones positioning 
       Botones = display.newImageRect( imgDir.. "p50_botones.png", 2176, 864 ); 
       ...
       kwkHija_gafas.x = 1941; kwkHija_gafas.y = 592; kwkHija_gafas.alpha = 1; kwkHija_gafas.oldAlpha = 1 
       ...
       kwkHormiga.x = 2042; kwkHormiga.y = 462; kwkHormiga.alpha = 1; kwkHormiga.oldAlpha = 1 
       ...
       kwkMama_gafas.x = 1711; kwkMama_gafas.y = 606; kwkMama_gafas.alpha = 1; kwkMama_gafas.oldAlpha = 1 
       ...
       -- Text1 positioning 
       Text1 = display.newImageRect( imgDir.. "p50_text1.png", 1475, 166 ); 
       ...
       -- A positioning 
       A = display.newImageRect( imgDir.. "p50_a.png", 1007, 51 ); 
       A.x = 1011; A.y = 307; A.alpha = 1; A.oldAlpha = 1 
       A.oriX = A.x; A.oriY = A.y 
       A.name = "A" 
       menuGroup:insert(A); menuGroup.A = A 

       -- B positioning 
       B = display.newImageRect( imgDir.. "p50_b.png", 289, 43 ); 
       B.x = 651; B.y = 399; B.alpha = 1; B.oldAlpha = 1 
       B.oriX = B.x; B.oriY = B.y 
       B.name = "B" 
       menuGroup:insert(B); menuGroup.B = B 

       -- C positioning 
       C = display.newImageRect( imgDir.. "p50_c.png", 181, 43 ); 
       C.x = 600; C.y = 491; C.alpha = 1; C.oldAlpha = 1 
       C.oriX = C.x; C.oriY = C.y 
       C.name = "C" 
       menuGroup:insert(C); menuGroup.C = C 

       -- D positioning 
       D = display.newImageRect( imgDir.. "p50_d.png", 316, 43 ); 
       D.x = 663; D.y = 592; D.alpha = 1; D.oldAlpha = 1 
       D.oriX = D.x; D.oriY = D.y 
       D.name = "D" 
       menuGroup:insert(D); menuGroup.D = D 

       -- E positioning 
       E = display.newImageRect( imgDir.. "p50_e.png", 846, 96 ); 
       E.x = 928; E.y = 706; E.alpha = 1; E.oldAlpha = 1 
       E.oriX = E.x; E.oriY = E.y 
       E.name = "E" 
       menuGroup:insert(E); menuGroup.E = E 

       -- circuloA positioning 
       circuloA = display.newImageRect( imgDir.. "p50_circuloa.png", 60, 60 ); 
       circuloA.x = 1551; circuloA.y = 303; circuloA.alpha = 1; circuloA.oldAlpha = 1 
       ...
       circuloB = display.newImageRect( imgDir.. "p50_circulob.png", 60, 60 ); 
       circuloB.x = 843; circuloB.y = 401; circuloB.alpha = 1; circuloB.oldAlpha = 1 
       ...
       circuloC = display.newImageRect( imgDir.. "p50_circuloc.png", 60, 60 ); 
       circuloC.x = 743; circuloC.y = 490; circuloC.alpha = 1; circuloC.oldAlpha = 1 
       ...
       circuloD = display.newImageRect( imgDir.. "p50_circulod.png", 60, 60 ); 
       circuloD.x = 861; circuloD.y = 594; circuloD.alpha = 1; circuloD.oldAlpha = 1 
       ...
       circuloE = display.newImageRect( imgDir.. "p50_circuloe.png", 60, 60 ); 
       circuloE.x = 886; circuloE.y = 741; circuloE.alpha = 1; circuloE.oldAlpha = 1 
       ...
       kwkTick.x = 978; kwkTick.y = 916; kwkTick.alpha = 1; kwkTick.oldAlpha = 1 
       kwkTick.oriX = kwkTick.x; kwkTick.oriY = kwkTick.y 
       kwkTick.name = "kwkTick" 
       menuGroup:insert(kwkTick); menuGroup.kwkTick = kwkTick 

       -- End3 positioning 
       End3 = display.newImageRect( imgDir.. "p50_end3.png", 497, 49 ); 
       End3.x = 1284; End3.y = 29; End3.alpha = 1; End3.oldAlpha = 1 
       End3.oriX = End3.x; End3.oriY = End3.y 
       End3.name = "End3" 
       menuGroup:insert(End3); menuGroup.End3 = End3 

       -- End1 positioning 
       End1 = display.newImageRect( imgDir.. "p50_end1.png", 383, 49 ); 
       End1.x = 1280; End1.y = 70; End1.alpha = 1; End1.oldAlpha = 1 
       End1.oriX = End1.x; End1.oriY = End1.y 
       End1.name = "End1" 
       menuGroup:insert(End1); menuGroup.End1 = End1 

       -- End2 positioning 
       End2 = display.newImageRect( imgDir.. "p50_end2.png", 1053, 51 ); 
       End2.x = 1283; End2.y = 29; End2.alpha = 1; End2.oldAlpha = 1 
       End2.oriX = End2.x; End2.oriY = End2.y 
       End2.name = "End2" 
       menuGroup:insert(End2); menuGroup.End2 = End2 

       -- End4 positioning 
       End4 = display.newImageRect( imgDir.. "p50_end4.png", 893, 51 ); 
       End4.x = 1280; End4.y = 28; End4.alpha = 1; End4.oldAlpha = 1 
       End4.oriX = End4.x; End4.oriY = End4.y 
       End4.name = "End4" 
       menuGroup:insert(End4); menuGroup.End4 = End4 
...
function end4()
	...
	updateCoefs()
       ...
       function hideInventory(event) 
            transitionStash.newTransition_684 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_684 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_684 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_685 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_685 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_685 = transition.to( kwkInvMaquina, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_686 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_686 = transition.to( kwkInvGuitarra, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_686 = transition.to( kwkInvCola, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_686 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
           InventoryShown = false
          saveKwikVars({"InventoryShown",false}) 
       end 

       function showInventory(event) 
            transitionStash.newTransition_703 = transition.to( kwkRectInv, {alpha=kwkRectInv.oldAlpha, time=0, delay=0}) 
         if (hasBiberon == true) then 
            transitionStash.newTransition_704 = transition.to( kwkInvBiberon, {alpha=kwkInvBiberon.oldAlpha, time=0, delay=0}) 
         end 
         if (hasTijeras == true) then 
            transitionStash.newTransition_705 = transition.to( kwkInvTijeras, {alpha=kwkInvTijeras.oldAlpha, time=0, delay=0}) 
         end 
         if (hasMaquina == true) then 
            transitionStash.newTransition_705 = transition.to( kwkInvMaquina, {alpha=kwkInvMaquina.oldAlpha, time=0, delay=0}) 
         end 
         if (hasRosa == true) then 
            transitionStash.newTransition_706 = transition.to( kwkInvRosa, {alpha=kwkInvRosa.oldAlpha, time=0, delay=0}) 
         end 
         if (hasErizo == true) then 
            transitionStash.newTransition_707 = transition.to( kwkInvErizo, {alpha=kwkInvErizo.oldAlpha, time=0, delay=0}) 
         end 
         if (hasCelo == true) then 
            transitionStash.newTransition_707 = transition.to( kwkInvCelo, {alpha=kwkInvCelo.oldAlpha, time=0, delay=0}) 
         end 
         if (hasGuitarra == true) then 
            transitionStash.newTransition_708 = transition.to( kwkInvGuitarra, {alpha=kwkInvGuitarra.oldAlpha, time=0, delay=0}) 
         end 
         if (hasCola == true) then 
            transitionStash.newTransition_709 = transition.to( kwkInvCola, {alpha=kwkInvCola.oldAlpha, time=0, delay=0}) 
         end 
           InventoryShown = true
          saveKwikVars({"InventoryShown",true}) 
            transitionStash.newTransition_725 = transition.to( kwkInvDestacado, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_726 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 
