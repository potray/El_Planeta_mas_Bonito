...
function new() 
    ...
    -- Audio callings 
    local narracion_page4 =  audio.loadStream( audioDir.."narracion_page47.mp3") 
...
local hasCola = kwkVarCheck("hasCola") 
       ...
       -- Text1 positioning 
       Text1 = display.newImageRect( imgDir.. "p59_text1.png", 1430, 109 ); 
       ...
       function hideInventory(event) 
            transitionStash.newTransition_651 = transition.to( kwkRectInv, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_652 = transition.to( kwkInvBiberon, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_652 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_652 = transition.to( kwkInvRosa, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_652 = transition.to( kwkInvErizo, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_653 = transition.to( kwkInvMaquina, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_653 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            ...
            transitionStash.newTransition_654 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
       ...
       function showInventory(event) 
         ...
         if (hasCola == true) then 
          ...
          saveKwikVars({"InventoryShown",true}) 
            transitionStash.newTransition_699 = transition.to( kwkInvDestacado, {alpha=0, time=0, delay=0}) 
            transitionStash.newTransition_699 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 
      ...
      --End Actions (functions) 
       ...
       function btnNextPage(self) 
            local myClosure_switch = function() 
                dispose(); director:changeScene( "page_60", "moveFromRight" ) 
            end 
            timerStash.newTimer_770 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
       ...
       function btnPrevPage(self) 
            local myClosure_switch = function() 
                dispose(); director:changeScene( "page_58", "moveFromLeft" ) 
            end 
            timerStash.newTimer_773 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
