...
function new() 
    ...
    -- Audio callings 
    local narracion_page2 =  audio.loadStream( audioDir.."narracion_page20.mp3") 
...
local hasCola = kwkVarCheck("hasCola") 
       ...
       -- Text1 positioning 
       Text1 = display.newImageRect( imgDir.. "p23_text1.png", 1361, 109 ); 
       Text1.x = 1273; Text1.y = 116; Text1.alpha = 1; Text1.oldAlpha = 1 
       ...
       function hideInventory(event) 
            ...
            transitionStash.newTransition_584 = transition.to( kwkInvTijeras, {alpha=0, time=0, delay=0}) 
            ...
            transitionStash.newTransition_585 = transition.to( kwkInvCelo, {alpha=0, time=0, delay=0}) 
            ...
            transitionStash.newTransition_586 = transition.to( kwkInvCerrar, {alpha=0, time=0, delay=0}) 
       ...
       function showInventory(event) 
         ...
         if (hasTijeras == true) then 
            transitionStash.newTransition_604 = transition.to( kwkInvTijeras, {alpha=kwkInvTijeras.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasCelo == true) then 
            transitionStash.newTransition_607 = transition.to( kwkInvCelo, {alpha=kwkInvCelo.oldAlpha, time=0, delay=0}) 
         end 
         ...
         if (hasCola == true) then 
          ...
          saveKwikVars({"InventoryShown",true}) 
            ...
            transitionStash.newTransition_626 = transition.to( kwkInvCerrar, {alpha=kwkInvCerrar.oldAlpha, time=0, delay=0}) 
       end 
      ...
      --End Actions (functions) 
       ...
       function btnNextPage(self) 
            ...
            timerStash.newTimer_827 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
       ...
       function btnPrevPage(self) 
            local myClosure_switch = function() 
                dispose(); director:changeScene( "page_21", "moveFromLeft" ) 
            end 
            timerStash.newTimer_835 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
